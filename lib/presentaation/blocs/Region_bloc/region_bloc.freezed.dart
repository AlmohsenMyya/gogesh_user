...
class _$_Load implements _Load {
  const _$_Load({required this.id});
...
abstract class _Load implements RegionEvent {
  const factory _Load({required final int id}) = _$_Load;
...
mixin _$RegionState {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(List<DataRegion> data) dataLoaded,
  ...
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<DataRegion> data)? dataLoaded,
...
class _$_DataLoaded implements _DataLoaded {
  const _$_DataLoaded({required final List<DataRegion> data}) : _data = data;
  ...
  @override
  String toString() {
    return 'RegionState.dataLoaded(data: $data)';
  }
...
abstract class _DataLoaded implements RegionState {
  const factory _DataLoaded({required final List<DataRegion> data}) =
      _$_DataLoaded;
