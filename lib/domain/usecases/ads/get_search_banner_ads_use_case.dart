...
class GetSearchBannerAdsUseCase implements UseCase<AdsPaginated, Filter> {
  final AdRepository _repository;

  GetSearchBannerAdsUseCase(this._repository);

  @override
  Future<Result<AdsPaginated, Exceptions>> call(Filter params) async {
    return _repository.fetchSearchBannerAds(params.toJson());
  }
}
